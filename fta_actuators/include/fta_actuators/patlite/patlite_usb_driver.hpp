...
// Patlite USB LED/Buzzer 제어를 위한 USB 통신 계층
//
// libusb-1.0 기반으로 USB 장치를 직접 제어
// USB 패킷 캡처 후 프로토콜 분석하여 구현
// ============================================================================

#ifndef FTA_ACTUATORS__PATLITE__PATLITE_USB_DRIVER_HPP_
#define FTA_ACTUATORS__PATLITE__PATLITE_USB_DRIVER_HPP_
...
namespace fta_actuators
{
    ...
    namespace patlite
    {
        ...
        private:
            ...
            // Non-copyable
            PatliteUsbDriver(const PatliteUsbDriver &) = delete;
            PatliteUsbDriver &operator=(const PatliteUsbDriver &) = delete;
        };
...
#endif // FTA_ACTUATORS__PATLITE__PATLITE_USB_DRIVER_HPP_
