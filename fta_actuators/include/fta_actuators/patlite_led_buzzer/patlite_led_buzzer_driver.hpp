#ifndef FTA_ACTUATORS__PATLITE_LED_BUZZER_DRIVER_HPP_
#define FTA_ACTUATORS__PATLITE_LED_BUZZER_DRIVER_HPP_
...
namespace fta_actuators
{
    ...
    // ============================================
    // PatliteLedBuzzer LED Color Enum (matches C# implementation)
    // ============================================
    enum class LEDColor
    {
        CLEAR = 0,     // Off
    ...
    // ============================================
    // PatliteLedBuzzer LED Pattern Enum (matches C# implementation)
    // ============================================
    ...
    // ============================================
    // PatliteLedBuzzer Buzzer Pattern Enum (matches C# implementation)
    // ============================================
    ...
    // ============================================
    // PatliteLedBuzzer Driver Class
    // Uses libusb-1.0 based PatliteLedBuzzerUsbDriver
    // ============================================
    class PatliteLedBuzzerDriver
    {
    public:
        PatliteLedBuzzerDriver();
        ~PatliteLedBuzzerDriver();
    ...
    private:
        bool is_connected_;
        std::unique_ptr<patlite_led_buzzer::PatliteLedBuzzerUsbDriver> usb_driver_;
    };

} // namespace fta_actuators

#endif  // FTA_ACTUATORS__PATLITE_LED_BUZZER_DRIVER_HPP_
