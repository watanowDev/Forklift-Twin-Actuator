...
namespace fta_actuators
{
  ...
  // 생성자
  // ============================================
  PatliteLedBuzzerNode::PatliteLedBuzzerNode(const rclcpp::NodeOptions &options)
      : Node("patlite_node", options),
        enabled_(true),
        volume_(50)
  {
    // �Ķ���� ����
    ...
    // PatliteLedBuzzer ����̹� �ʱ�ȭ
    driver_ = std::make_unique<PatliteLedBuzzerDriver>();
    if (!initialize_device())
    {
      RCLCPP_ERROR(this->get_logger(), "PatliteLedBuzzer ����̽� �ʱ�ȭ ����");
      publish_status("error", "Failed to initialize PatliteLedBuzzer device", 1);
      return;
    }
    ...
    action_sub_ = this->create_subscription<fta_interfaces::msg::ActionEvent>(
        "/actions/event",
        qos,
        std::bind(&PatliteLedBuzzerNode::action_callback, this, std::placeholders::_1));
  ...
  // �Ҹ���
  // ============================================
  PatliteLedBuzzerNode::~PatliteLedBuzzerNode()
  {
    cleanup_device();
  ...
  // ============================================
  bool PatliteLedBuzzerNode::initialize_device()
  {
  ...
  // ����̽� ����
  // ============================================
  void PatliteLedBuzzerNode::cleanup_device()
  {
    if (driver_)
    {
      // LED/Buzzer cleanup
  ...
  // �׼� �̺�Ʈ �ݹ�
  // ============================================
  void PatliteLedBuzzerNode::action_callback(const fta_interfaces::msg::ActionEvent::SharedPtr msg)
  {
    // ���߿����� Ÿ�� Ȯ��
  ...
  // LED/Buzzer �׼� ó��
  // ============================================
  bool PatliteLedBuzzerNode::handle_led_buzzer_action(
      ...
      const std::string &parameters)
  {
    ...
    try
    {
      ...
      if (action == "set_light")
      {
        ...
        LEDColor color = PatliteLedBuzzerDriver::parse_color(color_str);
        LEDPattern pattern = PatliteLedBuzzerDriver::parse_led_pattern(pattern_str);
      ...
      else if (action == "set_buzzer")
      {
        ...
        BuzzerPattern pattern = PatliteLedBuzzerDriver::parse_buzzer_pattern(pattern_str);
      ...
      else if (action == "set_all")
      {
        ...
        LEDColor color = PatliteLedBuzzerDriver::parse_color(color_str);
        LEDPattern led_pattern = PatliteLedBuzzerDriver::parse_led_pattern(led_pattern_str);
        BuzzerPattern buzzer_pattern = PatliteLedBuzzerDriver::parse_buzzer_pattern(buzzer_pattern_str);
  ...
  // ���� ����
  // ============================================
  void PatliteLedBuzzerNode::publish_status(
...
RCLCPP_COMPONENTS_REGISTER_NODE(fta_actuators::PatliteLedBuzzerNode)
