...
namespace fta_actuators
{
  ...
  // Constructor
  // ============================================
  PatliteLedBuzzerDriver::PatliteLedBuzzerDriver()
      : is_connected_(false),
        usb_driver_(std::make_unique<patlite_led_buzzer::PatliteLedBuzzerUsbDriver>())
  {
  }
  ...
  // ============================================
  bool PatliteLedBuzzerDriver::initialize()
  {
    // PatliteLedBuzzer USB Signal Beacon: Vendor ID = 0x191a, Product ID = 0x6001
    ...
    {
      std::cerr << "Failed to open PatliteLedBuzzer USB device (VID: 0x"
  ...
  // ============================================
  bool PatliteLedBuzzerDriver::close_device()
  {
  ...
  // ============================================
  bool PatliteLedBuzzerDriver::is_connected() const
  {
  ...
  // ============================================
  bool PatliteLedBuzzerDriver::set_light(LEDColor color, LEDPattern pattern)
  {
    if (!is_connected_)
    {
  ...
  // ============================================
  bool PatliteLedBuzzerDriver::set_buzzer(BuzzerPattern pattern, int volume, int count)
  {
    if (!is_connected_)
    {
      std::cerr << "Device not connected" << std::endl;
  ...
  // ============================================
  bool PatliteLedBuzzerDriver::set_all(LEDColor color, LEDPattern led_pattern,
  ...
  // ============================================
  bool PatliteLedBuzzerDriver::turn_off_all()
  {
    if (!is_connected_)
    {
      std::cerr << "Device not connected" << std::endl;
  ...
  // ============================================
  bool PatliteLedBuzzerDriver::get_device_state(bool &buzzer, bool &led, bool &touch)
  {
    if (!is_connected_)
    {
      std::cerr << "Device not connected" << std::endl;
  ...
  // ============================================
  LEDColor PatliteLedBuzzerDriver::parse_color(const std::string &color_str)
  {
  ...
  // ============================================
  LEDPattern PatliteLedBuzzerDriver::parse_led_pattern(const std::string &pattern_str)
  {
  ...
  // ============================================
  BuzzerPattern PatliteLedBuzzerDriver::parse_buzzer_pattern(const std::string &pattern_str)
  {
    std::string lower_str = pattern_str;
    std::transform(lower_str.begin(), lower_str.end(), lower_str.begin(),
                   [](unsigned char c)
